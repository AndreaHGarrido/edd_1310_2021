...
#● Insert( value ) 🡪 inserta un valor en la posición que le corresponde.
#● remove( value ) 🡪 elimina el nodo que contenga dicho valor.
#● search( value) 🡪 True o false
#● transversal( format ) 🡪 recorrido: preorden, postorden y inorden
